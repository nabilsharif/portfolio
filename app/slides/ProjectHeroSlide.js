...
export default class HeroSlide extends React.Component {
  render() {
    return <Slide className="slide--projectHero" skew={this.props.skew} backgroundImageUrl={this.props.backgroundImageUrl}>
        <div className="projectHero">
          ...
          <div className="projectInfo">
            ...
            <a href={this.props.projectUrl} style={{color: this.props.projectColor}} className="button projectHero__visitSiteButton">Visit Site</a>
          </div>
        </div>
      </Slide>
  }
